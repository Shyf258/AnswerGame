...
namespace APlus2
{
    public class Overview : Container
    {
        ...
        public void GenerateChildrens()
        {
            ...
            var columns = state.tableDef.GetAssetColumns(APlusConstants.OVERVIEW_MENU_KEY);
            ...
            {
                var dataSource = column.GetColumnAction().DoSort(table.listView.itemsSource as List<APAsset>);
