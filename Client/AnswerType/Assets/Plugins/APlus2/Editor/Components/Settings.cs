...
namespace APlus2
{
    public class Settings : Container
    {
        ...
        public static string CodeFileExtensions
        {
            get
            {
                return EditorPrefs.GetString(CODE_EXTENSION_KEY, APlusConstants.DEFAULT_SCRIPT_EXT);
            }
            set
            {
        ...
        private void RenderBlacklist()
        {
            ...
            {
                selectedBlacklist = objects[0].ToString();
        ...
        private void RenderCodeExtensionsSettings()
        {
            ...
            button.OnClick = () =>
            {
                CodeFileExtensions = APlusConstants.DEFAULT_SCRIPT_EXT;
                inputField.value = CodeFileExtensions;
            };
