...
namespace APlus2
{
    public partial class MainWindow : EditorWindow
    {
        ...
        private void UpdateUIToSelectedMenu()
        {
            ...
            {
                state.selectedMenuKey = APlusConstants.OVERVIEW_MENU_KEY;
            }
        ...
        private void CreateChangeHeaderList(List<Column> columns)
        {
            ...
            changeHeaderList.itemHeight = 24;
        ...
        private void RenderTable(List<Column> columns, List<APAsset> dataSource, Action<List<APAsset>> OnSorted)
        {
            ...
            {
                var ds = column.GetColumnAction().DoSort(dataSource);
        ...
        private void RenderTableToolbar()
        {
            ...
            if (state.selectedMenuKey == APlusConstants.IN_HIERACHY_MENU_KEY)
            {
        ...
        private void RefreshHierarchyData()
        {
            if (state.selectedMenuKey == APlusConstants.IN_HIERACHY_MENU_KEY)
            {
                ...
                this.RenderTable(
                    state.tableDef.GetAssetColumns(APlusConstants.IN_HIERACHY_MENU_KEY),
                    state.inHierachy,
        ...
        private NaviMenu RenderNaviMenu()
        {
            ...
            naviMenu.AddItem(new NaviMenuItemGroup(APlusConstants.OVERVIEW_MENU_KEY, "Overview"));
            naviMenu.AddItem(new NaviMenuItemGroup(APlusConstants.IN_HIERACHY_MENU_KEY, "In Hierarchy"));
            ...
            naviMenu.AddItem(new NaviMenuItemGroup(APlusConstants.SETTINGS_KEY, "Settings"));

            naviMenu.OnMenuItemClicked = menu =>
            {
                state.searchInputText = string.Empty;
                if (menu.key == APlusConstants.IN_HIERACHY_MENU_KEY)
                {
                    state.inHierachy = AssetsHelper.GetHierarchyAssets();
                }
        ...
        private void OnNaviMenuClick(NaviMenuItem naviMenuItem)
        {
            ...
            {
                case APlusConstants.SETTINGS_KEY:
                    this.RenderSettings();
                    break;
                case APlusConstants.IN_HIERACHY_MENU_KEY:
                    ...
                    break;
                case APlusConstants.OVERVIEW_MENU_KEY:
                    this.RenderOverview();
                    break;
                default:
