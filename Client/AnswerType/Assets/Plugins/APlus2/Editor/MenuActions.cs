...
namespace APlus2
{
    public partial class MainWindow
    {
        ...
        {
            if (state.selectedMenuKey == APlusConstants.SETTINGS_KEY)
            {
                if (settingsUI != null)
                {
            ...
            if (state.selectedMenuKey == APlusConstants.OVERVIEW_MENU_KEY)
            {
                this.RenderOverview();
                return;
            }
        ...
        public static bool ShowInAPlusEnable()
        {
            ...
            foreach (var item in Selection.objects)
            {
                ...
                types.Add(AssetsHelper.GetAssetTypeByObject(item));
            }
        ...
        public static void ShowInAPlus()
        {
            ...
            if (types.Count == 1)
            {
                ...
                Instance.state.selectedMenuKey = assetType;
